...
BLOG_AUTHOR = "Jüri Andrejev"  # (translatable)
BLOG_TITLE = "Sologile"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "http://jyriand.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://sologile.com/"
BLOG_EMAIL = "jyriand@gmail.com"
BLOG_DESCRIPTION = "Demo site"  # (translatable)
